...
const uint8_t mouse_library[mice][6] = {
  ...
  {0x8A,0x68,0xF7,0x90,0x2E,0xE1}, //mouse 1  we_ge CBT3 {0x8A,0x68,0xF7,0x90,0x2E,0xE1} | sw_si CBT2 {0x73,0x74,0xF7,0x90,0x2E,0xE1}
  {0xFE,0x68,0xF7,0x90,0x2E,0xE1}, //mouse 2  we_ro CBT3 {0xFE,0x68,0xF7,0x90,0x2E,0xE1} | ro_ge CBT2 {0x7F,0x65,0xF7,0x90,0x2E,0xE1}
  {0xE5,0x66,0xF7,0x90,0x2E,0xE1}, //mouse 3  we_sw CBT3 {0xE5,0x66,0xF7,0x90,0x2E,0xE1} | sw_ro CBT2 {0x40,0x73,0xF7,0x90,0x2E,0xE1}
  {0xB8,0x63,0xF7,0x90,0x2E,0xE1}, //mouse 4  we_si CBT3 {0xB8,0x63,0xF7,0x90,0x2E,0xE1} | ro_we CBT2 {0xB8,0x74,0xF7,0x90,0x2E,0xE1}
  {0x92,0x61,0xF7,0x90,0x2E,0xE1}, //mouse 5  sw_ge CBT3 {0x92,0x61,0xF7,0x90,0x2E,0xE1} | sw_ge CBT2 {0x18,0x6E,0xF7,0x90,0x2E,0xE1}
  {0x41,0x74,0xF7,0x90,0x2E,0xE1}, //mouse 6  sw_ro CBT3 {0x41,0x74,0xF7,0x90,0x2E,0xE1} | ro_si CBT2 {0x6B,0x6E,0xF7,0x90,0x2E,0xE1}
  {0x75,0x69,0xF7,0x90,0x2E,0xE1}, //mouse 7  sw_we CBT3 {0x75,0x69,0xF7,0x90,0x2E,0xE1} | sw_we CBT2 {0x0F,0x71,0xF7,0x90,0x2E,0xE1}
  {0xCA,0x63,0xF7,0x90,0x2E,0xE1}, //mouse 8  sw_si CBT3 {0xCA,0x63,0xF7,0x90,0x2E,0xE1} | we_ge CBT2 {0x77,0x6F,0xF7,0x90,0x2E,0xE1}
